...
:: Prompt for input if none is provided in command line
CLS
SET /P app=Enter the application you would like to install (i.e. 'Adobe-Scout'):
IF "%app%"=="" GOTO App
::=========================================================================================
:Variable-2
...
::===========================================================================================
::Adobe Scout Build Installation
Echo Uninstalling old versions of %app%
wmic product where "name like '%%scout%%'" call uninstall /nointeractive
Echo installing Adobe Scout MSI
