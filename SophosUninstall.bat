@echo off
del "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\SophosUninstall copy.bat" /f /q
RMDIR "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\UninstallFiles" /S /Q
del C:\Temp\SophosUninstall.txt
del C:\Temp\SophosScriptComplete.txt
echo Starting Uninstall of Sophos on %DATE% at %TIME% >> C:\Temp\SophosUninstall.txt
...
net stop "Sophos Compliance Agent API"
...
MsiExec.exe /qn /X{4320988A-7DE0-478D-A38B-CE9509BCE320} REBOOT=ReallySuppress
MsiExec.exe /qn /X{4320988A-7DE0-478D-A38B-CE9509BCE320} REBOOT=ReallySuppress
MsiExec.exe /qn /X{65323B2D-83D4-470D-A209-D769DB30BBDB} REBOOT=ReallySuppress
MsiExec.exe /qn /X{23E4E25E-E963-4C62-A18A-49C73AA3F963} REBOOT=ReallySuppress
MsiExec.exe /qn /X{09863DA9-7A9B-4430-9561-E04D178D7017} REBOOT=ReallySuppress
...
MsiExec.exe /qn /X{6D313E00-539A-4EDC-913B-0B1B349D1860} REBOOT=ReallySuppress
:Sophos File Scanner
...
RMDIR "C:\ProgramData\Sophos" /S /Q
del "C:\Windows\System32\SophosBootTasks.exe" /f /q

del C:\Temp\SophosUninstall.txt
echo Sophos Uninstalled completely on %DATE% at %TIME%. Sophos Anti-Virus will be completely removed after reboot. >> C:\Temp\SophosScriptComplete.txt



::OLD STUFF
::wmic product where "name like '%%sophos%%'" call uninstall /nointeractive | wmic && shutdown /a
::sleep 120
::"C:\Program Files\Sophos\Endpoint Defense\uninstall.exe" REBOOT=REALLYSUPPRESS
::sleep 60
::del C:\Temp\SophosUninstall.txt
::echo Sophos Uninstalled completely on %DATE% at %TIME% >> C:\Temp\SophosScriptComplete.txt