...
::---------------------------------::
:::::::::::::::::::::::::::::::::::::
:: Character Animator Installation ::
::          Robert Schroeder       ::
::             03/13/2018          ::
:::::::::::::::::::::::::::::::::::::
::---------------------------------::
...
:: Prompt for input if none is provided in command line
CLS
SET /P app=Enter the application you would like to install (i.e. 'Adobe-Photoshop'):
IF "%app%"=="" GOTO App
::=========================================================================================
:Variable-2
...
wmic product where "name like '%%Character%%Animator%%'" call uninstall /nointeractive
