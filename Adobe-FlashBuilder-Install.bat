...
:: Prompt for input if none is provided in command line
CLS
SET /P app=Enter the application you would like to install (i.e. 'Adobe-FlashBuilder'):
IF "%app%"=="" GOTO App
::=========================================================================================
:Variable-2
...
wmic product where "name like '%%Flash%%Builder%%'" call uninstall /nointeractive
Echo installing Adobe FlashBuilder MSI
