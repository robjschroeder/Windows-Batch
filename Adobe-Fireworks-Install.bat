...
:: Prompt for input if none is provided in command line
CLS
SET /P app=Enter the application you would like to install (i.e. 'Adobe-Fireworks'):
IF "%app%"=="" GOTO App
::=========================================================================================
:Variable-2
...
wmic product where "name like '%%Fireworks%%'" call uninstall /nointeractive
Echo installing Adobe Fireworks MSI
